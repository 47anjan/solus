...
const Community = () => (
  <section className="px-4 sm:px-8 py-16">
    <motion.div
      ...
      className="max-w-7xl mx-auto bg-white rounded-[3rem] p-14 md:p-16 flex flex-col md:flex-row md:items-center gap-12 relative overflow-hidden border border-stone-100 shadow-sm"
    >
